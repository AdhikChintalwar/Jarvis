...
print("=" * 100)
print("V4.5.8 LIVE RESILIENT TWO-STAGE DEEP INVESTMENT REASONING")
print("=" * 100)
...
print("=" * 100)
print("V4.5.8 DEEP REASONING INSPECTION")
print("=" * 100)
print("Provider status:", result.get("provider_status", "UNKNOWN"))
print("Committee schema:", result.get("committee_schema", {}))
print("Deterministic only:", result.get("deterministic_only"))
print("LLM weight:", result.get("llm_weight"))
print("Deliberation status:", result.get("deliberation_status"))
...
for r in rankings:
    ...
    print("LLM weight          :", r.get("llm_weight"))
    ...
    print("  Factual integrity :", d.get("integrity_score"))
    print("  Schema integrity  :", d.get("schema_integrity"))
    print("  Effective integrity:", d.get("effective_integrity"))
    print("  Accepted claims   :", d.get("accepted_claim_count"))
    print("  Rejected claims   :", d.get("rejected_claim_count"))
