...
class BabyInvestmentSystem:
    """V4.8.4 deterministic decision + hardened compatibility boundary.
    ...
    def evaluate(self, report:dict[str,Any], history:pd.DataFrame|None=None,
        ...
        return InvestmentSystemResult(symbol,asdict(decision),asdict(validation),
            asdict(trade) if trade else None,provider_meta)
