...
MATERIAL=['earnings','guidance','offering','merger','acquisition','fda','bankruptcy','buyback','dividend','lawsuit','contract','management']
def classify(text):
...
def build_events(symbol,news=None,research=None):
 ...
 d['event_count']=len(out); d['event_coverage']=100.0 if out else 0.0; d['metric_coverage']=d.get('coverage',0.0); d['coverage']=d['event_coverage']; d['events']=out[:50]; d['production_sec_stage']=sec or {}; return d
