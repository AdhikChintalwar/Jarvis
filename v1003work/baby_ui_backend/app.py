...
app=FastAPI(title='Baby UI Gateway',version='10.0.3')
...
@app.get('/')
def root(): return {'service':'BABY UI Gateway','version':'10.0.3','ui':'http://127.0.0.1:5173','docs':'/docs'}
@app.get('/api/health')
def health(): return {'status':'ok','version':'10.0.3','ai_scoring_authority':0.0,'real_money_execution':'DISABLED','quote_refresh_seconds':float(os.getenv('BABY_QUOTE_REFRESH_SECONDS','10'))}
